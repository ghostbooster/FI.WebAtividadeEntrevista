...
namespace FI.AtividadeEntrevista.BLL
{
    public class BoCliente
    {
        ...
        {
            DAL.DaoCliente cli = new DAL.DaoCliente();
            cli.IncluirBeneficiario(cliente, beneficiario);
        }
        ...
        {
            DAL.DaoCliente cli = new DAL.DaoCliente();
            cli.AlterarBeneficiario(cliente, beneficiario);
        }
        ...
        /// <param name="cliente">Objeto de cliente</param>
        /// <param name="cliente">Objeto de beneficiário do cliente</param>
        public void ExcluirBeneficiario(DML.Cliente cliente, DML.Beneficiario beneficiario)
        {
            DAL.DaoCliente cli = new DAL.DaoCliente();
            cli.ExcluirBeneficiario(beneficiario);
        }
        ...
        /// <returns></returns>
        public bool VerificarExistencia(DML.Cliente cliente)
        {
            DAL.DaoCliente cli = new DAL.DaoCliente();
            return cli.VerificarExistencia(cliente);
        }
    }
}
